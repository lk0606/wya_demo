<template>
    <div class="dialog-wrap">
        <div class="dialog">
            ...
            <div>
                <button class="button button-save" @click="editAddress(newAddress)">
                    保存
                </button>
                <button class="button button-del" @click="delAddress">
                    删除
                </button>
            </div>
        </div>
        ...
        return {
            newAddress: {
                name:{
                    ...
                    value: this.editAddressData.name
                },
                tel:{
                    name: '手机号码',
                    type: 'tel',
                    placeholder: 15910012002,
                    value: this.editAddressData.tel
                },
                zone:{
                    name: '区域信息',
                    type: 'text',
                    placeholder: '请填写区域信息',
                    value: this.editAddressData.zone
                },
                address:{
                    name: '详细地址',
                    type: 'text',
                    placeholder: '请输入街道门牌信息',
                    value: this.editAddressData.address
                },
                postalCode:{
                    name: '邮政编码',
                    type: 'tel',
                    placeholder: '可以不填',
                    value: this.editAddressData.postalCode
                }
            },
            isPass: false
        }
